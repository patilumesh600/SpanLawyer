...
import { faEnvelope, faCommentAlt, faCopy, faPaperPlane } from '@fortawesome/free-regular-svg-icons';
...
function ReferAndEarn() {
  return <>
   <RBS.Col className=" text-center shareHeading" md={12} xs={12}><h2>Tell your friends about us and win exiciting gifts!</h2></RBS.Col>
                <div className="clearfix"></div>
                <RBS.Col className=" text-center shareIcon" md={12} xs={12}><FontAwesomeIcon icon={faGifts} /> </RBS.Col>
                <RBS.Col className=" text-center" md={12} xs={12}>
                  <RBS.Col md={{ span: 4, offset: 4 }} >
                    ...
                    <br />
                    <RBS.Button block type="button" variant="warning"><FontAwesomeIcon icon={faPaperPlane} /> Invite Friends</RBS.Button>
                  </RBS.Col>
                </RBS.Col>
  </>;
}
